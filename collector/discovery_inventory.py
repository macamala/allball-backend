...
COVERAGE: List[CoverageRow] = [
    ...
    _c("football", "us", "usa-usl-championship", "TheSportsDB", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="mapped"),
    ...
    _c("basketball", "us", "wnba", "TheSportsDB", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="mapped"),
    _c("basketball", "mx", "mexico-lnbp", "TheSportsDB", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="mapped"),
    # --- tennis ---
    ...
    _c("ice-hockey", "fi", "finland-liiga", "TheSportsDB", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="mapped"),
    # --- baseball ---
    ...
    _c("snooker", "world", "snooker-org-api", "snooker.org API", "snooker-org", "JSON 401", "n/a", "n/a", "n/a", "n/a", "n/a", "n/a", "n/a", False, "restricted", 99, probe="401"),
    # --- darts ---
    ...
    _c("winter-sports", "world", "biathlon", "IBU datacenter HTML", "ibu-web", "public HTML", "Y", "Y", "Y", "Y", "Y", "N", "N", True, "unclear", 4, probe="prior HTML 200"),
    ...
    _c("esports", "world", "cross-game-wiki", "Liquipedia gzip API", "liquipedia", "gzip JSON/HTML", "N", "Y", "Y", "Y", "N", "N", "N", False, "unclear", 4, probe="MODEL_SCOPE_BLOCKER umbrella; replaced by formula-3"),
    ...
    _c("football", "us", "mls", "TheSportsDB id 4346", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="200 lookupleague"),
    ...
    _c("football", "ar", "argentina-primera", "TheSportsDB id 4406", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="TSDB map"),
    ...
    _c("ice-hockey", "fi", "finland-liiga", "liiga.fi ohjelma HTML", "liiga-web", "public HTML", "Y", "Y", "Y", "Y", "Y", "N", "N", True, "unclear", 4, probe="200"),
    ...
    _c("football", "at", "austria-bundesliga", "TheSportsDB id 4621", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="TSDB map + family JSON 200"),
    ...
    _c("football", "th", "thai-league-1", "TheSportsDB id 4743", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="TSDB map + family JSON 200"),
    ...
    _c("football", "in", "india-super-league", "TheSportsDB id 4791", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="TSDB map + family JSON 200"),
    ...
    _c("football", "mx", "mexico-liga-mx", "TheSportsDB id 4350", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="TSDB map + family JSON 200"),
    ...
    _c("football", "asia", "afc-champions-league", "TheSportsDB id 4719", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="TSDB map + family JSON 200"),
    ...
    _c("football", "africa", "caf-champions-league", "TheSportsDB id 4720", "thesportsdb", "free JSON truncated", "N", "Y", "Y", "Y", "N", "N", "N", True, "permitted", 1, probe="TSDB map + family JSON 200"),
    ...
    _c("tennis", "world", "wta-tour", "SportScore widget JSON", "sportscore", "public JSON", "Y", "Y", "Y", "N", "N", "N", "N", True, "permitted", 2, probe="Kayla Day vs Liudmila Samsonova 2026-09-17; attribution required"),
    _c("tennis", "world", "atp-tour", "SportScore widget JSON", "sportscore", "public JSON", "Y", "Y", "Y", "N", "N", "N", "N", True, "permitted", 2, probe="Martin Borisiouk vs Florent Bax 2026-09-17; attribution required"),
