...
_IMPLEMENTED = {
    ...
    "fotmob": {
        ...
        "implemented": True,
        "adapter": "fotmob",
        "transport": "www.fotmob.com/api/data/matches + matchDetails on-demand + leagues table",
    ...
    "mlb-statsapi": {
        ...
        "limitation": "Play-by-play truncated to recent plays; standings from statsapi standings",
    },
    "nhl-web": {
        "timeline": "PROVEN",
        "stats": "PROVEN",
        ...
        "limitation": "Period scores from scoreByPeriod when present; standings from /v1/standings/now",
    },
    "pulselive": {
        "timeline": "PARTIAL",
        "stats": "PARTIAL",
    ...
    "jolpica-ergast": {
        ...
        "adapter": "jolpica-f1",
        "transport": "api.jolpi.ca/ergast/f1 results",
        "limitation": "Race classification when round results exist; sampled Italian GP was scheduled with empty classification",
    },
    "dataproject-wcm": {
        "timeline": "NO_ACCESSIBLE_DATA_FOUND",
        "stats": "NO_ACCESSIBLE_DATA_FOUND",
    ...
    "world-aquatics-api": {
        ...
        "sport_detail": "PARTIAL",
        "implemented": True,
        "adapter": "world-aquatics-api",
        "transport": "api.worldaquatics.com competitions catalog",
        "limitation": "Meet/program list only; heat/final times not mapped",
    },
    "altiusrt-html": {
        "timeline": "NO_ACCESSIBLE_DATA_FOUND",
        "stats": "NO_ACCESSIBLE_DATA_FOUND",
        ...
        "sport_detail": "PARTIAL",
        "implemented": True,
        "adapter": "altiusrt-html",
        "transport": "FIH AltiusRT public match HTML",
        "limitation": "Score/status from listing HTML; REST API is credentialed",
    },
}


def _partial_family(adapter: str, transport: str, limitation: str, **caps: str) -> Dict[str, Any]:
    spec = {
        "timeline": "NO_ACCESSIBLE_DATA_FOUND",
        "stats": "NO_ACCESSIBLE_DATA_FOUND",
        "lineups": "NO_ACCESSIBLE_DATA_FOUND",
...
for _fam, _row in {
    "liquipedia": _partial_family("liquipedia", "liquipedia.net api.php parse", "Series score from match-info HTML; maps when listed"),
    "nll-web": _partial_family("nll-web", "nll.com schedule + sportspress JSON", "Score/status; quarters when present on recap JSON"),
    "pll-web": _partial_family("pll-web", "premierlacrosseleague.com public pages", "Score/status when listing HTML exposes them"),
    "world-lacrosse-web": _partial_family("world-lacrosse-web", "worldlacrosse.sport results HTML", "International results pages"),
    "futsalplanet": _partial_family("futsalplanet", "futsalplanet.com competitions.aspx", "Futsal score/status from competition tables"),
    "lnf-web": _partial_family("lnf-web", "lnf.com.br public results", "Brazil LNF scores when HTML tables parse"),
    "uefa-futsal-web": _partial_family("uefa-futsal-web", "uefa.com futsal HTML", "UEFA futsal listing scores"),
    "wikipedia-fifa-futsal-web": _partial_family("wikipedia-fifa-futsal-web", "Wikipedia FIFA Futsal pages", "Historical tournament scores; not live"),
    "fifa-digital": _partial_family("fifa-json", "FIFA digital public JSON where reachable", "Connected FIFA competitions when endpoint returns events"),
    "fiaf2-web": _partial_family("fiaf2-web", "fiaformula2.com Standings/Driver", "Driver classification; not live timing", periods="NOT_APPLICABLE", standings="PARTIAL"),
    "fiaf3-web": _partial_family("fiaf3-web", "fiaformula3.com Standings/Driver", "Driver classification; not live timing", periods="NOT_APPLICABLE", standings="PARTIAL"),
    "ibu-web": _partial_family("ibu-web", "biathlonresults.com SportAPI Events", "Meet/program; race rank/shooting when Results API used"),
    "fis-web": _partial_family("fis-web", "fis-ski.com results HTML", "Rank/time when result tables parse"),
    "ettu-news-results": _partial_family("ettu-news-results", "ettu.org news/results HTML", "Event listing; set scores when published"),
    "ettu-web": _partial_family("ettu-web", "ettu.org public pages", "ETTU event listing"),
    "wikipedia-all-england-web": _partial_family("wikipedia-all-england-web", "Wikipedia All England Open", "Round/winner historical; not live court feed"),
    "wikipedia-indonesia-open-web": _partial_family("wikipedia-indonesia-open-web", "Wikipedia Indonesia Open", "Round/winner historical; not live court feed"),
    "aso-letour": _partial_family("aso-letour", "letour.fr public stage pages", "Stage classification when HTML tables parse", periods="NOT_APPLICABLE"),
    "pcs-web": _partial_family("pcs-web", "procyclingstats public HTML", "UCI calendar/results when reachable"),
    "rte-cycling": _partial_family("rte-cycling", "RTE cycling HTML", "Stage recap scores"),
    "uci-web": _partial_family("uci-web", "uci.org calendar", "Calendar listing; gap/GC only when published"),
    "gpcqm-web": _partial_family("gpcqm-web", "GPCQM public pages", "Canadian calendar listing"),
    "world-aquatics-web": _partial_family("world-aquatics-web", "worldaquatics.com results HTML", "Meet program; heat/final times when listed"),
    "world-netball-web": _partial_family("world-netball-web", "netball.sport public pages", "International fixtures/scores"),
    "wikipedia-vct-web": _partial_family("wikipedia-vct-web", "Wikipedia VCT", "Series results historical"),
    "wikipedia-rlcs-web": _partial_family("wikipedia-rlcs-web", "Wikipedia RLCS", "Series results historical"),
    "wikipedia-owcs-world-finals-web": _partial_family("wikipedia-owcs-world-finals-web", "Wikipedia OWCS finals", "Series results historical"),
    "fcpro-web": _partial_family("fcpro-web", "EA FC Pro public pages", "Bracket/series when listed"),
    "cdl-web": _partial_family("cdl-web", "callofdutyleague.com", "CDL scores when public listing parses"),
    "bbc-sport": _partial_family("bbc-sport", "bbc.com/sport HTML", "Score/status; snooker frames when BBC publishes them"),
    "cue-tracker": _partial_family("cue-tracker", "cuetracker.net public HTML", "Snooker frame scores when tables parse"),
    "wst-web": _partial_family("wst-web", "wst.tv public pages", "Snooker draw/results when HTML parses"),
    "standardbred-canada-web": _partial_family("standardbred-canada-web", "standardbredcanada.ca", "RAPID_RESULT race cards; never LIVE", periods="NOT_APPLICABLE", timeline="NOT_APPLICABLE", stats="NOT_APPLICABLE", lineups="NOT_APPLICABLE", standings="NOT_APPLICABLE"),
    "letrot-web": _partial_family("letrot-web", "letrot.com meetings", "RAPID_RESULT; never LIVE", periods="NOT_APPLICABLE", timeline="NOT_APPLICABLE", stats="NOT_APPLICABLE", lineups="NOT_APPLICABLE", standings="NOT_APPLICABLE"),
    "gri-web": _partial_family("gri-web", "GRI greyhound results", "RAPID_RESULT; never LIVE", periods="NOT_APPLICABLE", timeline="NOT_APPLICABLE", stats="NOT_APPLICABLE", lineups="NOT_APPLICABLE", standings="NOT_APPLICABLE"),
    "equidia-web": _partial_family("equidia-web", "equidia.fr meetings", "RAPID_RESULT; never LIVE", periods="NOT_APPLICABLE", timeline="NOT_APPLICABLE", stats="NOT_APPLICABLE", lineups="NOT_APPLICABLE", standings="NOT_APPLICABLE"),
    "woodbine-mohawk-web": _partial_family("woodbine-mohawk-web", "Woodbine Mohawk HTML", "RAPID_RESULT; never LIVE", periods="NOT_APPLICABLE", timeline="NOT_APPLICABLE", stats="NOT_APPLICABLE", lineups="NOT_APPLICABLE", standings="NOT_APPLICABLE"),
    "world-athletics-web": _partial_family("world-athletics-web", "worldathletics.org", "Heat/final rank/time when result tables parse"),
    "cricsheet": _partial_family("cricsheet-json", "cricsheet.org recently_added_7_json.zip", "Historical innings/result; never LIVE"),
    "fivb-web": _partial_family("volleyballworld", "en.volleyballworld.com", "Set scores when listing HTML parses"),
    "volleytimes-web": _partial_family("eurosport-volleyball", "VolleyTimes/Eurosport HTML", "Set scores when listing parses"),
}.items():
    _IMPLEMENTED.setdefault(_fam, _row)
