...
_IMPLEMENTED = {
    ...
    "fotmob": {
        ...
        "limitation": "Detail fetched on-demand, not on the live list",
    },
    "sofascore-web": {
        "timeline": "PARTIAL",
        "stats": "PARTIAL",
    ...
    "wta-json": {
        ...
        "limitation": "Match score derived from completed sets only; WTA serve stats not mapped yet",
    },
    "mlb-statsapi": {
        "timeline": "PARTIAL",
        "stats": "PARTIAL",
        ...
        "transport": "statsapi.mlb.com schedule hydrate=linescore + feed/live on-demand",
        "limitation": "Play-by-play and box score on-demand only",
    },
    "nhl-web": {
        "timeline": "PARTIAL",
        "stats": "PARTIAL",
        "lineups": "SOURCE_AVAILABLE_NOT_IMPLEMENTED",
        "periods": "PARTIAL",
        "standings": "SOURCE_AVAILABLE_NOT_IMPLEMENTED",
        "player_stats": "SOURCE_AVAILABLE_NOT_IMPLEMENTED",
        "venue": "PARTIAL",
        ...
        "implemented": True,
        "adapter": "nhl-web",
        "transport": "api-web.nhle.com scoreboard + gamecenter landing on-demand",
        "limitation": "Goal timeline from landing; full PBP not stored",
    },
    "pga-graphql": {
        "timeline": "NOT_APPLICABLE",
        "stats": "PARTIAL",
