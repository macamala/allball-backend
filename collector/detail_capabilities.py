...
_FAMILY_DETAIL: Dict[str, Dict[str, bool]] = {
    ...
    "fotmob": {"timeline": True, "periods": True, "stats": True, "lineups": True, "standings": False},
    "sofascore-web": {"timeline": True, "periods": True, "stats": True, "lineups": True, "standings": False},
    "mlb-statsapi": {"timeline": True, "periods": True, "stats": True, "lineups": True, "standings": False},
    "nhl-web": {"timeline": True, "periods": True, "stats": True, "lineups": False, "standings": False},
