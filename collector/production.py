...
def _feed_sources() -> list:
    return [
        ...
        dict(
            ...
            display_name="SportScore Global Live Scores",
            kind="dynamic",
            enabled=True,
            adapter_key="sportscore",
            attribution_required=True,
            attribution_text="Powered by SportScore",
            attribution_url="https://sportscore.com/",
            license_name="SportScore public widget terms",
            public_branding_required=True,
            rate_limit_per_minute=20,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": True, "standings": True}),
            sports_supported_json=dump_json(["basketball", "tennis", "cricket"]),
        ...
        dict(
            ...
            attribution_url="https://www.fotmob.com/",
            license_name="public website JSON",
        ...
        dict(
            ...
            display_name="OpenFootball CC0 Global",
            kind="dynamic",
            enabled=True,
            adapter_key="openfootball-json",
            attribution_required=False,
            attribution_text=None,
            attribution_url="https://github.com/openfootball",
            license_name="CC0-1.0 public domain",
            public_branding_required=False,
            rate_limit_per_minute=30,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": False, "standings": False}),
            sports_supported_json=dump_json(["football"]),
            upstream_family="openfootball",
            source_type="public-domain dataset",
            independence_status="established",
        ),
        dict(
            source_id="bbc-tennis-global",
            display_name="BBC Tennis Dated Board",
            kind="dynamic",
            enabled=True,
            adapter_key="bbc-sport",
            attribution_required=False,
            attribution_text=None,
            attribution_url="https://www.bbc.com/sport/tennis/scores-and-schedule",
            license_name="public website data",
            public_branding_required=False,
            rate_limit_per_minute=12,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": True, "standings": False}),
            sports_supported_json=dump_json(["tennis"]),
        ...
        dict(
            ...
            display_name="WTA Official Global",
            kind="dynamic",
            enabled=True,
            adapter_key="wta-json",
            attribution_required=False,
            attribution_text=None,
            attribution_url="https://www.wtatennis.com/",
            license_name="official public website JSON",
            public_branding_required=False,
            rate_limit_per_minute=20,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": True, "standings": False}),
            sports_supported_json=dump_json(["tennis"]),
            upstream_family="wta-json",
            source_type="official public JSON",
            independence_status="established",
        ),
        dict(
            source_id="espn-tennis-global",
            display_name="ESPN Tennis Date Board",
            kind="dynamic",
            enabled=True,
            adapter_key="espn-json",
            attribution_required=False,
            attribution_text=None,
            attribution_url="https://www.espn.com/tennis/",
            license_name="public website JSON",
            public_branding_required=False,
            rate_limit_per_minute=12,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": True, "standings": False}),
        ...
        dict(
            ...
            display_name="Volleyball World Global",
            kind="dynamic",
            enabled=True,
            adapter_key="volleyballworld",
            attribution_required=False,
            attribution_text=None,
            attribution_url="https://en.volleyballworld.com/volleyball/competitions/",
            license_name="official public web data",
            public_branding_required=False,
            rate_limit_per_minute=12,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": True, "standings": True}),
            sports_supported_json=dump_json(["volleyball"]),
            upstream_family="volleyballworld",
            source_type="official public web data",
            independence_status="established",
        ),
        dict(
            source_id="asobal-global",
            display_name="Liga ASOBAL Official Calendar",
            kind="dynamic",
            enabled=True,
            adapter_key="asobal-web",
            attribution_required=False,
            attribution_text=None,
            attribution_url="https://asobal.es/liga/calendario/",
            license_name="official public schedule",
            public_branding_required=False,
            rate_limit_per_minute=12,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": False, "standings": False}),
            sports_supported_json=dump_json(["handball"]),
        ...
        dict(
            ...
            display_name="EHF Global Official",
            kind="dynamic",
            enabled=True,
            adapter_key="ehf-web",
            attribution_required=False,
            attribution_text=None,
            attribution_url="https://old.eurohandball.com/events/competitions",
            license_name="official public web data",
            public_branding_required=False,
            rate_limit_per_minute=12,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": False, "standings": True}),
            sports_supported_json=dump_json(["handball"]),
        ...
        dict(
            ...
            display_name="FIBA Global Games",
            kind="dynamic",
            enabled=True,
            adapter_key="fiba-web",
            attribution_required=False,
            attribution_text=None,
            attribution_url="https://www.fiba.basketball/",
            license_name="public website data",
            public_branding_required=False,
            rate_limit_per_minute=12,
            capabilities_json=dump_json({"fixtures": True, "results": True, "live_scores": True, "standings": False}),
            sports_supported_json=dump_json(["basketball"]),
