...
EXTRA_COMPETITIONS: Dict[str, CompetitionRecord] = {
    ...
    "irish-greyhound-derby": {
        "competition_id": "irish-greyhound-derby",
        "sport_id": "greyhound-racing",
        "country_id": "ie",
        "region_id": "europe",
        "name": "Irish Greyhound Derby",
        "official_name": "BOYLE Sports Irish Greyhound Derby",
        "slug": "irish-greyhound-derby",
        "aliases": ["irish greyhound derby", "boyle sports irish greyhound derby", "shelbourne derby"],
    ...
    "owcs-world-finals": {
        "competition_id": "owcs-world-finals",
        "sport_id": "overwatch",
        "country_id": None,
        "region_id": "world",
        "name": "OWCS World Finals",
        "official_name": "Overwatch Champions Series World Finals",
        "slug": "owcs-world-finals",
        "aliases": ["owcs world finals", "overwatch champions series world finals", "overwatch world finals"],
        "competition_type": "tournament",
        "gender": None,
        "level": "international",
        "active": True,
